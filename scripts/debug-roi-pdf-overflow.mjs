...
function log(pdf, label) {
  console.log(`${label}: page=${pdf.getCurrentPageInfo().pageNumber} total=${pdf.getNumberOfPages()}`);
}
...
async function main() {
  ...
  const longPlant =
    "Jaisalmer Solar Park Phase II North Block Extension Array Field Alpha Beta Gamma";
  ...
  buildRoiPdfDocument({
    ...
    labels: {
      title: en.pdfTitle,
      generatedOn: "Generated on Monday, June 22, 2026 at 3:45:30 PM IST",
      generatedFor: `Generated for: ${longPlant}`,
      plantName: longPlant,
      region: en.pdfRegion,
      regionName: "India",
    ...
    inputRows: [
      { label: en.plantName, value: longPlant },
