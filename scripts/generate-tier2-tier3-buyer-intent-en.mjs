  ...
  "solar-cleaning-robot-manufacturer-india.json": {
    ManufacturerIndiaPage: {
      ...
      prose: {
        ...
        p2: "Taypro manufactures in Chakan, Pune and deploys the same robots under robot CAPEX + AMC or OPEX managed service. You get hardware, operators, spares, and NECTYR fleet portal from one accountable vendor.",
      ...
      faq: faq(
        ...
        [
          ...
          },
          {
            ...
            a: "Yes. Same robots deployed under OPEX — manufacturer owns fleet and bills per panel cleaned.",
          },
          {
