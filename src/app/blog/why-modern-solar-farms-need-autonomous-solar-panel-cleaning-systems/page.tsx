...
export const metadata: Metadata = {
  title: "Why Modern Solar Farms Need Autonomous Solar Panel Cleaning Systems - Taypro Blog",
  description: "Traditional solar panel cleaning methods have long been the standard in the solar energy industry, yet they present several significant drawbacks that hinder efficiency and sustainability.",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-07-02-at-12.09.02_800372c0-e1741337984870.jpg"],
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "Why Modern Solar Farms Need Autonomous Solar Panel Cleaning Systems", href: "" },
  ];
