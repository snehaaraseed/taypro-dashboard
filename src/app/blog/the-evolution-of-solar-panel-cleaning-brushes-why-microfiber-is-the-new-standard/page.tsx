...
export const metadata: Metadata = {
  title: "The Evolution of Solar Panel Cleaning Brushes: Why Microfiber is the New Standard - Taypro Blog",
  description: "With the increasing demand for energy and the necessity to address climate change, solar panels are now being looked at as a major determinant of the transition towards renewable energy. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "The Evolution of Solar Panel Cleaning Brushes: Why Microfiber is the New Standard - Taypro Blog",
    description: "With the increasing demand for energy and the necessity to address climate change, solar panels are now being looked at as a major determinant of the transition towards renewable energy.",
    url: `${siteUrl}/blog/the-evolution-of-solar-panel-cleaning-brushes-why-microfiber-is-the-new-standard`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "The Evolution of Solar Panel Cleaning Brushes: Why Microfiber is the New Standard - Taypro Blog",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/the-evolution-of-solar-panel-cleaning-brushes-why-microfiber-is-the-new-standard`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "the-evolution-of-solar-panel-cleaning-brushes-why-microfiber-is-the-new-standard";
