...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "Microfiber vs. Traditional Brushes: Why Taypro’s Patented Dual Pass Solar Panel Cleaning System Outperforms", href: "" },
  ];
