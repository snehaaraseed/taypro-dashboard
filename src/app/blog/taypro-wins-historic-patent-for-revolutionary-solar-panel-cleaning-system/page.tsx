...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/03/Patent-Certificate.jpg",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              TAYPRO Wins Historic Patent for Revolutionary Solar Panel Cleaning
              System
            </h1>
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              In a first for India’s renewable energy sector, TAYPRO, the solar
              technology pioneer, has been awarded a patent for its
              groundbreaking “System for Cleaning Solar Panels.”
            </h2>
          </header>
        </div>
      </section>
