...
export const metadata: Metadata = {
  title: "The Science Behind Effective Solar Module Cleaning Systems: A Technical Comparison of Traditional and Modern Approaches - Taypro Blog",
  description: "Solar module cleaning is a crucial aspect of maintaining the efficiency and longevity of solar energy systems. ",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-08-16-at-11.06.29_a9eb12ef.jpg"],
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "The Science Behind Effective Solar Module Cleaning Systems: A Technical Comparison of Traditional and Modern Approaches", href: "" },
  ];
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-08-16-at-11.06.29_a9eb12ef.jpg"
