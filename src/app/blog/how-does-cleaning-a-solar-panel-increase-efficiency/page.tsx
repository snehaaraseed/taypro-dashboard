...
export const metadata: Metadata = {
  ...
  description: "The primary advantage of solar panel cleaning is the increased efficiency of the solar panels. Know more about the role of solar cleaning in enhancing the overall efficiency of the solar plant Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/how-does-cleaning-a-solar-panel-increase-efficiency`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/03/TAYPRO-OPEX-SOLAR-PANEL-CLEANING-SERVICE.jpg`,
        width: 1200,
        height: 630,
        alt: "How Does Cleaning A Solar Panel Increase Efficiency? - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "How Does Cleaning A Solar Panel Increase Efficiency? - Taypro Blog",
    description: "The primary advantage of solar panel cleaning is the increased efficiency of the solar panels. Know more about the role of solar cleaning in enhancing the overall efficiency of the solar plant",
    images: [`${siteUrl}/uploads/2024/03/TAYPRO-OPEX-SOLAR-PANEL-CLEANING-SERVICE.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/how-does-cleaning-a-solar-panel-increase-efficiency`,
  },
};
