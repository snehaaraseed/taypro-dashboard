...
export const metadata: Metadata = {
  ...
  description: "The primary advantage of solar panel cleaning is the increased efficiency of the solar panels. Know more about the role of solar cleaning in enhancing the overall efficiency of the solar plant",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/03/How-Does-Cleaning-A-Solar-Panel-Increases-Its-Efficiency.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/03/How-Does-Cleaning-A-Solar-Panel-Increases-Its-Efficiency.webp"
