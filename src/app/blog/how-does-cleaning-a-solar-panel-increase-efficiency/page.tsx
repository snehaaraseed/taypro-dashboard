...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/03/How-Does-Cleaning-A-Solar-Panel-Increases-Its-Efficiency.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              The primary advantage of solar panel cleaning is the increased
              efficiency of the solar panels. Know more about the role of solar
              cleaning in enhancing the overall efficiency of the solar plant
            </h2>
          </header>
        </div>
      </section>
