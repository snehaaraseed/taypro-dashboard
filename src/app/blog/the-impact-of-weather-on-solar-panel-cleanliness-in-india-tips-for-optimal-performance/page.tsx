...
export const metadata: Metadata = {
  title:
    "The Impact of Weather on Solar Panel Cleanliness in India: Tips for Optimal Performance - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "In recent years, India has made significant strides in adopting solar energy as a primary source of renewable power. As the country aims to boost its renewable energy capacity, solar power emerges as a vital component in achieving energy independence and sustainability.",
    url: `https://yourdomain.com/blog/the-impact-of-weather-on-solar-panel-cleanliness-in-india-tips-for-optimal-performance`,
    type: "article",
    images: [
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              The Impact of Weather on Solar Panel Cleanliness in India: Tips
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              In recent years, India has made significant strides in adopting
              solar energy as a primary source of renewable power. As the
              country aims to boost its renewable energy capacity, solar power
              emerges as a vital component in achieving energy independence and
              sustainability.
            </h2>
          </header>
        </div>
