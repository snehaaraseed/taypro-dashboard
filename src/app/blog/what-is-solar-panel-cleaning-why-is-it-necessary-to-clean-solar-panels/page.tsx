        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              What Is Solar Panel Cleaning? Why Is It Necessary To Clean Solar
              Panels?
            </h1>
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar panels are a vital source for generating renewable energy
              through sunlight. As India is rapidly transitioning towards
              sustainability, solar energy has been contributing around 47% to
              the country’s renewable energy production.
            </h2>
          </header>
        </div>
      </section>
