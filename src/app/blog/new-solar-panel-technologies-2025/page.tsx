...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/07/Feature-IMage-6.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              This blog helps us understand new solar technology, its benefits,
              and how it contributes to shaping the future of solar energy.
            </h2>
          </header>
        </div>
      </section>
