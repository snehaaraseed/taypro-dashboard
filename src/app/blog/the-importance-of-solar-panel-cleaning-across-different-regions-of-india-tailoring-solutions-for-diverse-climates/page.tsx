...
export const metadata: Metadata = {
  title:
    "The Importance of Solar Panel Cleaning Across Different Regions of India: Tailoring Solutions for Diverse Climates - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "India has emerged as a leading player in the global solar energy landscape, driven by a commitment to harness renewable energy sources to combat climate change and fulfill growing energy demands.",
    url: `https://yourdomain.com/blog/the-importance-of-solar-panel-cleaning-across-different-regions-of-india-tailoring-solutions-for-diverse-climates`,
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/01/5f23d94a-ffad-4e5b-bc43-502ac9df40eb.jpg.webp",
    ],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/01/5f23d94a-ffad-4e5b-bc43-502ac9df40eb.jpg.webp"
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              ...
              India: Tailoring Solutions for Diverse Climates
            </h1>
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              India has emerged as a leading player in the global solar energy
              landscape, driven by a commitment to harness renewable energy
              sources to combat climate change and fulfill growing energy
              demands.
            </h2>
          </header>
        </div>
