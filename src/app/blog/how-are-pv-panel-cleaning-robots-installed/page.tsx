...
export const metadata: Metadata = {
  ...
  description: "Solar cleaning robots are crucial for sustaining the efficiency of solar panels. Read more to know what is the process of installing solar module cleaning robots in a solar power plant. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/how-are-pv-panel-cleaning-robots-installed`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "How Are PV Panel Cleaning Robots Installed? - Taypro Blog",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/how-are-pv-panel-cleaning-robots-installed`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "how-are-pv-panel-cleaning-robots-installed";
