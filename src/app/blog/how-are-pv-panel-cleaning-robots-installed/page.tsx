...
export const metadata: Metadata = {
  ...
  description: "Solar cleaning robots are crucial for sustaining the efficiency of solar panels. Read more to know what is the process of installing solar module cleaning robots in a solar power plant. ",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/04/PV-Panel-Cleaning-Robots-Installation.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/04/PV-Panel-Cleaning-Robots-Installation.webp"
