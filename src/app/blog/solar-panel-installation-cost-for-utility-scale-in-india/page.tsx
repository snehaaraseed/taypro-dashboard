...
export const metadata: Metadata = {
  title:
    "Solar Panel Installation Cost For Utility Scale In India - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "Solar energy has become a vital source of sustainability in today’s energy-deficient world. So, read this blog for the understanding of the solar installation and the costs involved in the utility scale solar panels installations. ",
    url: `https://yourdomain.com/blog/solar-panel-installation-cost-for-utility-scale-in-india`,
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/05/Feature-IMage-2.webp",
    ],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/05/Feature-IMage-2.webp"
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar energy has become a vital source of sustainability in
              today’s energy-deficient world. So, read this blog for the
              understanding of the solar installation and the costs involved in
              the utility scale solar panels installations.
            </h2>
          </header>
        </div>
      </section>
