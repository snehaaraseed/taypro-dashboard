...
export const metadata: Metadata = {
  title: "Cost-Benefit Analysis of Solar Panel Cleaning Services in India - Taypro Blog",
  description: "India’s solar energy sector has witnessed remarkable growth in recent years, encompassing a vital component of the country’s renewable energy landscape. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "Cost-Benefit Analysis of Solar Panel Cleaning Services in India - Taypro Blog",
    description: "India’s solar energy sector has witnessed remarkable growth in recent years, encompassing a vital component of the country’s renewable energy landscape.",
    url: `${siteUrl}/blog/cost-benefit-analysis-of-solar-panel-cleaning-services-in-india`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/03/TeamTaypro-2048x924.jpg`,
        width: 1200,
        height: 630,
        alt: "Cost-Benefit Analysis of Solar Panel Cleaning Services in India - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "Cost-Benefit Analysis of Solar Panel Cleaning Services in India - Taypro Blog",
    description: "India’s solar energy sector has witnessed remarkable growth in recent years, encompassing a vital component of the country’s renewable energy landscape.",
    images: [`${siteUrl}/uploads/2024/03/TeamTaypro-2048x924.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/cost-benefit-analysis-of-solar-panel-cleaning-services-in-india`,
  },
};
