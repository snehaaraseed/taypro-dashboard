...
export const metadata: Metadata = {
  ...
  description: "With the worldwide rising solar energy adoption, solar panel efficiency has become an important aspect of energy production. This blog helps us understand what solar panel efficiency is and the factors affecting and improving it. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/what-is-solar-panel-efficiency`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "What is Solar Panel Efficiency? - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "What is Solar Panel Efficiency? - Taypro Blog",
    description: "With the worldwide rising solar energy adoption, solar panel efficiency has become an important aspect of energy production. This blog helps us understand what solar panel efficiency is and the factor",
    images: [`${siteUrl}/uploads/2024/03/image.png`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/what-is-solar-panel-efficiency`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "what-is-solar-panel-efficiency";
