...
export const metadata: Metadata = {
  ...
  description: "With the worldwide rising solar energy adoption, solar panel efficiency has become an important aspect of energy production. This blog helps us understand what solar panel efficiency is and the factors affecting and improving it.",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/05/Feature-IMage4-1.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/05/Feature-IMage4-1.webp"
