        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              The increasing energy demands have led to the rise of solar energy
              adoption as an efficient energy source. In this blog, we will
              discuss the types of solar panels and have a detailed analysis of
              them.
            </h2>
          </header>
        </div>
