...
export const metadata: Metadata = {
  title: "Innovations in Solar Cleaning Systems: What India’s Top Farms Are Using - Taypro Blog",
  description: "In recent years, the adoption of solar energy has grown significantly across India, necessitating the development of effective maintenance solutions, particularly solar cleaning systems. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "Innovations in Solar Cleaning Systems: What India’s Top Farms Are Using - Taypro Blog",
    description: "In recent years, the adoption of solar energy has grown significantly across India, necessitating the development of effective maintenance solutions, particularly solar cleaning systems.",
    url: `${siteUrl}/blog/innovations-in-solar-cleaning-systems-what-indias-top-farms-are-using`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/08/silhouette-photography-of-assorted-solar-panel-behind-trees-3-scaled.jpg`,
        width: 1200,
        height: 630,
        alt: "Innovations in Solar Cleaning Systems: What India’s Top Farms Are Using - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "Innovations in Solar Cleaning Systems: What India’s Top Farms Are Using - Taypro Blog",
    description: "In recent years, the adoption of solar energy has grown significantly across India, necessitating the development of effective maintenance solutions, particularly solar cleaning systems.",
    images: [`${siteUrl}/uploads/2024/08/silhouette-photography-of-assorted-solar-panel-behind-trees-3-scaled.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/innovations-in-solar-cleaning-systems-what-indias-top-farms-are-using`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "innovations-in-solar-cleaning-systems-what-indias-top-farms-are-using";
