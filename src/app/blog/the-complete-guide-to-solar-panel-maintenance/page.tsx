...
export const metadata: Metadata = {
  ...
  description: "Solar maintenance is an important aspect of maintaining the efficiency of your solar plant. This blog provides a guide to solar panel maintenance and its importance. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/the-complete-guide-to-solar-panel-maintenance`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/03/image-7.png`,
        width: 1200,
        height: 630,
        alt: "The Complete Guide to Solar Panel Maintenance - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "The Complete Guide to Solar Panel Maintenance - Taypro Blog",
    description: "Solar maintenance is an important aspect of maintaining the efficiency of your solar plant. This blog provides a guide to solar panel maintenance and its importance.",
    images: [`${siteUrl}/uploads/2024/03/image-7.png`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/the-complete-guide-to-solar-panel-maintenance`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "the-complete-guide-to-solar-panel-maintenance";
            ...
            <div className="flex-1 lg:max-w-3xl">
              ...
              <section className="pb-10">
                <div className="relative w-full h-96 mb-8 overflow-hidden rounded-lg bg-gray-100">
                  <Image
                    src="/uploads/2024/03/image-7.png"
