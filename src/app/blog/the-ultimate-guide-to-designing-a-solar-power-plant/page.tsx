...
export const metadata: Metadata = {
  ...
  description: "To achieve the best energy production results, one must primarily focus on designing the perfect solar power plant layout. This blog will help you understand how you can design a solar plant layout and other important aspects to be considered for higher efficiency. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/the-ultimate-guide-to-designing-a-solar-power-plant`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "The Ultimate Guide to Designing a Solar Power Plant - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "The Ultimate Guide to Designing a Solar Power Plant - Taypro Blog",
    description: "To achieve the best energy production results, one must primarily focus on designing the perfect solar power plant layout. This blog will help you understand how you can design a solar plant layout an",
    images: [`${siteUrl}/uploads/2024/03/image.png`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/the-ultimate-guide-to-designing-a-solar-power-plant`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "the-ultimate-guide-to-designing-a-solar-power-plant";
