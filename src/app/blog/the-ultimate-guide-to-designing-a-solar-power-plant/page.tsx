...
export const metadata: Metadata = {
  ...
  description: "To achieve the best energy production results, one must primarily focus on designing the perfect solar power plant layout. This blog will help you understand how you can design a solar plant layout and other important aspects to be considered for higher efficiency.",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/05/Feature-IMage5.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/05/Feature-IMage5.webp"
