...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-07-02-at-12.09.05_053d3db1.jpg"],
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "Why Solar Power Plants Need Robotic Cleaning for Maximum ROI", href: "" },
  ];
