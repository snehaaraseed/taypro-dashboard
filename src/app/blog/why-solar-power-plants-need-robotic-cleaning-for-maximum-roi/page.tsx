...
export const metadata: Metadata = {
  title:
    "Why Solar Power Plants Need Robotic Cleaning for Maximum ROI - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "Solar power has emerged as a pivotal element in the quest for sustainable energy sources, reflecting a critical shift towards renewable energy in the contemporary landscape. ",
    url: `https://yourdomain.com/blog/why-solar-power-plants-need-robotic-cleaning-for-maximum-roi`,
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-07-02-at-12.09.05_053d3db1.jpg",
    ],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/01/WhatsApp-Image-2024-07-02-at-12.09.05_053d3db1.jpg"
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar power has emerged as a pivotal element in the quest for
              sustainable energy sources, reflecting a critical shift towards
              renewable energy in the contemporary landscape.
            </h2>
          </header>
        </div>
      </section>
