...
export const metadata: Metadata = {
  title: "Benefits Of Using Solar Panel Cleaning Robot In A Solar Plant - Taypro Blog",
  description: "Conventional methods of solar cleaning are becoming increasingly inefficient and costly due labour dependency and water wastage. Solar panel cleaning robot has come up as a solution with its Next-Gen cleaning mechanism, ensuring high uptime and optimised power generation. ",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/04/Solar-Cleaning-Robots-In-A-Solar-Plant.webp"],
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "Benefits Of Using Solar Panel Cleaning Robot In A Solar Plant", href: "" },
  ];
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/04/Solar-Cleaning-Robots-In-A-Solar-Plant.webp"
