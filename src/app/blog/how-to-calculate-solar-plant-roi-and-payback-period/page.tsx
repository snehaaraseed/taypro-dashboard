...
export const metadata: Metadata = {
  ...
  description: "Installing a solar energy system is a lifetime investment. In this blog, we will discuss how to calculate the solar plant ROI & payback period, and important factors affecting them.",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/07/TP-1.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/07/TP-1.webp"
