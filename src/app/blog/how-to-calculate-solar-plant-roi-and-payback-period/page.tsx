        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Installing a solar energy system is a lifetime investment. In this
              blog, we will discuss how to calculate the solar plant ROI &
              payback period, and important factors affecting them.
            </p>
          </header>
        </div>
      </section>
