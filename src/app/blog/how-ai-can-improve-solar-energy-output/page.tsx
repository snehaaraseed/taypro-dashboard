...
export const metadata: Metadata = {
  ...
  description: "AI has gained profound importance in the generation of solar energy. Solar power companies are capitalising on the revolutionary opportunities laid by Artificial Intelligence. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/how-ai-can-improve-solar-energy-output`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "How AI Can Improve Solar Energy Output? - Taypro Blog",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/how-ai-can-improve-solar-energy-output`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "how-ai-can-improve-solar-energy-output";
