        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              AI has gained profound importance in the generation of solar
              energy. Solar power companies are capitalising on the
              revolutionary opportunities laid by Artificial Intelligence.
            </h2>
          </header>
        </div>
      </section>
