...
export const metadata: Metadata = {
  ...
  description: "Solar panels have emerged as a pivotal solution for sustainable energy in India, catering to the increasing demand for renewable energy sources. With abundant sunlight available throughout the year, solar energy provides an eco-friendly alternative to traditional power generation methods. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "How Often Should You Clean Your Solar Panels in India? - Taypro Blog",
    description: "Solar panels have emerged as a pivotal solution for sustainable energy in India, catering to the increasing demand for renewable energy sources. With abundant sunlight available throughout the year, solar energy provides an eco-friendly alternative to traditional power generation methods.",
    url: `${siteUrl}/blog/how-often-should-you-clean-your-solar-panels-in-india`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2022/07/coworkers-team-working-brainstorming-concept-1.jpg`,
        width: 1200,
        height: 630,
        alt: "How Often Should You Clean Your Solar Panels in India? - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "How Often Should You Clean Your Solar Panels in India? - Taypro Blog",
    description: "Solar panels have emerged as a pivotal solution for sustainable energy in India, catering to the increasing demand for renewable energy sources. With abundant sunlight available throughout the year, s",
    images: [`${siteUrl}/uploads/2022/07/coworkers-team-working-brainstorming-concept-1.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/how-often-should-you-clean-your-solar-panels-in-india`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "how-often-should-you-clean-your-solar-panels-in-india";
