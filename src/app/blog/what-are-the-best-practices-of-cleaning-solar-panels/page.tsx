...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "What Are The Best Practices Of Cleaning Solar Panels? - Taypro Blog",
    description:
      "Solar panel cleaning is the best way to optimise energy production and improve longevity. There are several best practices to incorporate in the daily operations of solar modules to sustain their efficiency. ",
    url: `https://yourdomain.com/blog/what-are-the-best-practices-of-cleaning-solar-panels`,
    type: "article",
    images: ["/uploads/2024/08/c6777f15-b591-482d-8fca-b7b1dfd1f08c-768x768.jpg"],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar panel cleaning is the best way to optimise energy production
              and improve longevity. There are several best practices to
              incorporate in the daily operations of solar modules to sustain
              their efficiency.
            </h2>
          </header>
        </div>
