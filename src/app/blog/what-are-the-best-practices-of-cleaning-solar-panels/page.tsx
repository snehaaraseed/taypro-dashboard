...
export const metadata: Metadata = {
  ...
  description: "Solar panel cleaning is the best way to optimise energy production and improve longevity. There are several best practices to incorporate in the daily operations of solar modules to sustain their efficiency. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/what-are-the-best-practices-of-cleaning-solar-panels`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/08/c6777f15-b591-482d-8fca-b7b1dfd1f08c-768x768.jpg`,
        width: 1200,
        height: 630,
        alt: "What Are The Best Practices Of Cleaning Solar Panels? - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "What Are The Best Practices Of Cleaning Solar Panels? - Taypro Blog",
    description: "Solar panel cleaning is the best way to optimise energy production and improve longevity. There are several best practices to incorporate in the daily operations of solar modules to sustain their effi",
    images: [`${siteUrl}/uploads/2024/08/c6777f15-b591-482d-8fca-b7b1dfd1f08c-768x768.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/what-are-the-best-practices-of-cleaning-solar-panels`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "what-are-the-best-practices-of-cleaning-solar-panels";
            ...
            <div className="flex-1 lg:max-w-3xl">
              ...
              <section className="pb-10">
                <div className="relative w-full h-96 mb-8 overflow-hidden rounded-lg bg-gray-100">
                  <Image
                    src="/uploads/2024/08/c6777f15-b591-482d-8fca-b7b1dfd1f08c-768x768.jpg"
