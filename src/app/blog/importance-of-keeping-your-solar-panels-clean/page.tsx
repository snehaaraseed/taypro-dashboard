...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: ["/uploads/2022/07/certificate-1-512x450.png"],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar Cleaning is a pivotal aspect in the production of solar
              energy. It maintains the productivity of the solar panels and
              prevents any disruption. When not cleaned occasionally, the
              efficiency of solar panels gets hampered leading to power and
              revenue loss.
            </h2>
          </header>
        </div>
