...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/importance-of-keeping-your-solar-panels-clean`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2022/07/certificate-1-512x450.png`,
        width: 1200,
        height: 630,
        alt: "Importance Of Keeping Your Solar Panels Clean - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "Importance Of Keeping Your Solar Panels Clean - Taypro Blog",
    description: "Solar Cleaning is a pivotal aspect in the production of solar energy. It maintains the productivity of the solar panels and prevents any disruption. When not cleaned occasionally, the efficiency of so",
    images: [`${siteUrl}/uploads/2022/07/certificate-1-512x450.png`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/importance-of-keeping-your-solar-panels-clean`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "importance-of-keeping-your-solar-panels-clean";
            ...
            <div className="flex-1 lg:max-w-3xl">
              ...
              <section className="pb-10">
                <div className="relative w-full h-96 mb-8 overflow-hidden rounded-lg bg-gray-100">
                  <Image
                    src="/uploads/2022/07/certificate-1-512x450.png"
