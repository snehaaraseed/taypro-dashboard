...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/03/1-1.png"],
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "What Are The Benefits Of Cleaning Solar Panels Regularly?", href: "" },
  ];
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/03/1-1.png"
