...
export const metadata: Metadata = {
  title: "What Are The Benefits Of Cleaning Solar Panels Regularly? - Taypro Blog",
  description: "Solar panel cleaning is important to enhance solar power generation. Without effective solar panel cleaning, there will be a significant reduction in the performance ratio of the solar power plant. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "What Are The Benefits Of Cleaning Solar Panels Regularly? - Taypro Blog",
    description: "Solar panel cleaning is important to enhance solar power generation. Without effective solar panel cleaning, there will be a significant reduction in the performance ratio of the solar power plant.",
    url: `${siteUrl}/blog/what-are-the-benefits-of-cleaning-solar-panels-regularly`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/08/1-150x150.jpeg`,
        width: 1200,
        height: 630,
        alt: "What Are The Benefits Of Cleaning Solar Panels Regularly? - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "What Are The Benefits Of Cleaning Solar Panels Regularly? - Taypro Blog",
    description: "Solar panel cleaning is important to enhance solar power generation. Without effective solar panel cleaning, there will be a significant reduction in the performance ratio of the solar power plant.",
    images: [`${siteUrl}/uploads/2024/08/1-150x150.jpeg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/what-are-the-benefits-of-cleaning-solar-panels-regularly`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "what-are-the-benefits-of-cleaning-solar-panels-regularly";
