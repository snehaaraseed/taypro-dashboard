...
export default async function BlogPost() {
  ...
  const currentSlug = "indias-solar-energy-boom-in-2024-what-it-means-for-you-and-the-planet";

  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    {
      name: "India's Solar Energy Boom in 2024: What It Means for You and the Planet",
      href: "",
    },
  ];
            ...
            <div className="flex-1 lg:max-w-3xl">
              ...
              <section className="pb-10">
                ...
                <div className="relative w-full h-96 mb-8 overflow-hidden rounded-lg bg-gray-100">
                  <Image
                    src="/uploads/2024/08/1-600x600.jpeg"
                ...
                <header className="mb-8">
                  <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
                    India's Solar Energy Boom in 2024: What It Means for You and the
                    Planet
                  </h1>
                  ...
                  <h2 className="text-lg text-gray-700 leading-relaxed">
                    2024 was not all about numbers. It was all about human beings.
                    Farmers, families, and even children in rural villages felt the
                    impact of a record 24.5 gigawatts (GW) of new solar power.
                  </h2>
                </header>
              </section>
