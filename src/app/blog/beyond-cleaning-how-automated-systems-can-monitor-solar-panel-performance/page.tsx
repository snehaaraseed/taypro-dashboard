...
export const metadata: Metadata = {
  title: "Beyond Cleaning: How Automated Systems Can Monitor Solar Panel Performance - Taypro Blog",
  description: "In the rapidly advancing field of solar energy, the role of automated cleaning robots has emerged as a potent solution to ensure the optimal functioning of solar panels. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "Beyond Cleaning: How Automated Systems Can Monitor Solar Panel Performance - Taypro Blog",
    description: "In the rapidly advancing field of solar energy, the role of automated cleaning robots has emerged as a potent solution to ensure the optimal functioning of solar panels.",
    url: `${siteUrl}/blog/beyond-cleaning-how-automated-systems-can-monitor-solar-panel-performance`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Beyond Cleaning: How Automated Systems Can Monitor Solar Panel Performance - Taypro Blog",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/beyond-cleaning-how-automated-systems-can-monitor-solar-panel-performance`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "beyond-cleaning-how-automated-systems-can-monitor-solar-panel-performance";
