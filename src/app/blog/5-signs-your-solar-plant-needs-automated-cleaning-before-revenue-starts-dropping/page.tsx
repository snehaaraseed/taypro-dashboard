...
export const metadata: Metadata = {
  ...
  description: "The significance of maintenance in solar power plants cannot be overstated. As the demand for renewable energy solutions continues to rise, ensuring the efficiency and performance of solar panels is essential for maximizing energy production. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/5-signs-your-solar-plant-needs-automated-cleaning-before-revenue-starts-dropping`,
    type: "article",
    images: [
      {
        url: `${siteUrl}/uploads/2024/02/IMG_20230603_153257-scaled.jpg`,
        width: 1200,
        height: 630,
        alt: "5 Signs Your Solar Plant Needs Automated Cleaning Before Revenue Starts Dropping - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "5 Signs Your Solar Plant Needs Automated Cleaning Before Revenue Starts Dropping - Taypro Blog",
    description: "The significance of maintenance in solar power plants cannot be overstated. As the demand for renewable energy solutions continues to rise, ensuring the efficiency and performance of solar panels is e",
    images: [`${siteUrl}/uploads/2024/02/IMG_20230603_153257-scaled.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/5-signs-your-solar-plant-needs-automated-cleaning-before-revenue-starts-dropping`,
  },
};

export default async function BlogPost() {
  const allBlogs = await getAllBlogsForSimilar();
  const currentSlug = "5-signs-your-solar-plant-needs-automated-cleaning-before-revenue-starts-dropping";

  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    {
      name: "5 Signs Your Solar Plant Needs Automated Cleaning Before Revenue Starts Dropping",
      href: "",
    },
  ];
            ...
            <div className="flex-1 lg:max-w-3xl">
              ...
              <section className="pb-10">
                <div className="relative w-full h-96 mb-8 overflow-hidden rounded-lg bg-gray-100">
                  <Image
                    src="/uploads/2024/02/IMG_20230603_153257-scaled.jpg"
