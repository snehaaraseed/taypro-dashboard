...
export const metadata: Metadata = {
  title:
    "5 Signs Your Solar Plant Needs Automated Cleaning Before Revenue Starts Dropping - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "/uploads/2024/02/IMG_20230603_153257-scaled.jpg",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              5 Signs Your Solar Plant Needs Automated Cleaning Before Revenue
              Starts Dropping
            </h1>
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              The significance of maintenance in solar power plants cannot be
              overstated. As the demand for renewable energy solutions continues
              to rise, ensuring the efficiency and performance of solar panels
              is essential for maximizing energy production.
            </h2>
          </header>
        </div>
      </section>
