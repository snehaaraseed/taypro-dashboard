...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/07/Feature-IMage-5.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Since solar energy is widely preferred and adopted by consumers,
              it’s essential for everyone to know about solar maintenance. This
              blog will concentrate on a solar panel maintenance checklist,
              providing an overview of the various methods involved.
            </h2>
          </header>
        </div>
      </section>
