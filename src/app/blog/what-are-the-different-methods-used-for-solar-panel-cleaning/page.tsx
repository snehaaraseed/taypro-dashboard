...
export const metadata: Metadata = {
  title:
    "What Are The Different Methods Used For Solar Panel Cleaning? - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "According to the IEA’s Renewable 2024 Report, solar energy systems contributed 75% of all global renewable energy capacity in 2023. ",
    url: `https://yourdomain.com/blog/what-are-the-different-methods-used-for-solar-panel-cleaning`,
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/03/1.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/03/1.webp"
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              According to the IEA’s Renewable 2024 Report, solar energy systems
              contributed 75% of all global renewable energy capacity in 2023.
            </h2>
          </header>
        </div>
      </section>
