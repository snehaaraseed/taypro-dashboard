...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/04/Feature-Image-1.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              A solar panel cleaning robot is an essential device used to clean
              solar panels using AI & ML-oriented technology. This article will
              explore: what is a solar cleaning robot, its features, benefits
