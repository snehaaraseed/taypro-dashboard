...
export const metadata: Metadata = {
  title: "Mint Tech4Good Awards 2024: Taypro’s Green AI Solutions Win Big in Mumbai, India - Taypro Blog",
  description: "The Mint Tech4Good Awards 2024 are a significant initiative that seeks to recognize innovative technological interventions that solve immediate social and environmental issues. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    title: "Mint Tech4Good Awards 2024: Taypro’s Green AI Solutions Win Big in Mumbai, India - Taypro Blog",
    description: "The Mint Tech4Good Awards 2024 are a significant initiative that seeks to recognize innovative technological interventions that solve immediate social and environmental issues.",
    url: `${siteUrl}/blog/mint-tech4good-awards-2024-taypros-green-ai-solutions-win-big-in-mumbai-india`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Mint Tech4Good Awards 2024: Taypro’s Green AI Solutions Win Big in Mumbai, India - Taypro Blog",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/mint-tech4good-awards-2024-taypros-green-ai-solutions-win-big-in-mumbai-india`,
  },
};
...
export default function BlogPost() {
  const breadcrumbs = [
    { name: "Home", href: "/" },
    { name: "Blog", href: "/blog" },
    { name: "Mint Tech4Good Awards 2024: Taypro’s Green AI Solutions Win Big in Mumbai, India", href: "" },
  ];
