...
export const metadata: Metadata = {
  title:
    "The Importance of Solar Panel Cleaning: Maximizing Efficiency and Energy Production - Taypro Blog",
  description:
  ...
  openGraph: {
    ...
    description:
      "Solar energy has emerged as a pivotal component in the global transition towards sustainable energy sources. As concerns over climate change intensify and the depletion of fossil fuels becomes increasingly apparent, societies worldwide are exploring renewable energy solutions.",
    url: `https://yourdomain.com/blog/the-importance-of-solar-panel-cleaning-maximizing-efficiency-and-energy-production`,
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2022/05/smarter-better-community.jpg",
    ],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2022/05/smarter-better-community.jpg"
          ...
          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-semibold text-[#052638] mb-4 leading-tight">
              The Importance of Solar Panel Cleaning: Maximizing Efficiency and
              Energy Production
            </h1>
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar energy has emerged as a pivotal component in the global
              transition towards sustainable energy sources. As concerns over
              climate change intensify and the depletion of fossil fuels becomes
              increasingly apparent, societies worldwide are exploring renewable
              energy solutions.
            </h2>
          </header>
        </div>
