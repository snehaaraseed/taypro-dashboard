...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/07/What-are-different-types-of-solar-panels.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar energy has played a pivotal role in meeting the power
              requirement in both residential and commercial fields. India
              positioned itself at 5th rank worldwide in solar cell deployment
              across the country, irrespective of urban and rural areas.
            </h2>
          </header>
        </div>
      </section>
