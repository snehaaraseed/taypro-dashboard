...
export const metadata: Metadata = {
  ...
  description: "Solar energy has played a pivotal role in meeting the power requirement in both residential and commercial fields. India positioned itself at 5th rank worldwide in solar cell deployment across the country.",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/07/What-are-different-types-of-solar-panels.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/07/What-are-different-types-of-solar-panels.webp"
          ...
          <header className="mb-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Solar energy has played a pivotal role in meeting the power requirement in both residential and commercial fields. India positioned itself at 5th rank worldwide in solar cell deployment across the country.
            </p>
          </header>
        </div>
      </section>
