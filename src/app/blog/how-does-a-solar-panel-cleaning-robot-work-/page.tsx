...
export const metadata: Metadata = {
  ...
  description: "Solar panel cleaning is essential for optimised efficiency and power generation. Solar panel cleaning robot helps in maintaining the cleanliness of the solar panels. Read this blog for an elaborate understanding of solar panel cleaning robots and their functioning. ",
  ...
  openGraph: {
    ...
    type: "article",
    images: ["https://taypro.in/wp-content/uploads/2025/04/How-Do-Solar-Panel-Cleaning-Robots-Work.webp"],
  },
};
      ...
      <section className="w-full pt-20 pb-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative w-full h-96 mb-8 overflow-hidden">
            <Image
              src="https://taypro.in/wp-content/uploads/2025/04/How-Do-Solar-Panel-Cleaning-Robots-Work.webp"
