...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      "https://taypro.in/wp-content/uploads/2025/04/How-Do-Solar-Panel-Cleaning-Robots-Work.webp",
    ],
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-lg text-gray-700 leading-relaxed">
              Solar panel cleaning is essential for optimised efficiency and
              power generation. Solar panel cleaning robot helps in maintaining
              the cleanliness of the solar panels. Read this blog for an
              elaborate understanding of solar panel cleaning robots and their
              functioning.
            </h2>
          </header>
        </div>
