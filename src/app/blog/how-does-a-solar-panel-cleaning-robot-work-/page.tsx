...
export const metadata: Metadata = {
  ...
  description: "Solar panel cleaning is essential for optimised efficiency and power generation. Solar panel cleaning robot helps in maintaining the cleanliness of the solar panels. Read this blog for an elaborate understanding of solar panel cleaning robots and their functioning. Learn more about Solar Panel Cleaning Robot solutions and best practices.",
  keywords: [
  ...
  openGraph: {
    ...
    url: `${siteUrl}/blog/how-does-a-solar-panel-cleaning-robot-work-`,
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "How Does A Solar Panel Cleaning Robot Work?  - Taypro Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "How Does A Solar Panel Cleaning Robot Work?  - Taypro Blog",
    description: "Solar panel cleaning is essential for optimised efficiency and power generation. Solar panel cleaning robot helps in maintaining the cleanliness of the solar panels. Read this blog for an elaborate un",
    images: [`${siteUrl}/uploads/2024/03/Automatic-Solar-Panel-Cleaning-Robots-Installation.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/blog/how-does-a-solar-panel-cleaning-robot-work-`,
  },
};
