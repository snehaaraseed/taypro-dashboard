      ...
      if (response.ok) {
        ...
        if (data.success) {
          setFormData({
            ...
            codename: data.project.codename ?? null,
            displayTitle: data.project.displayTitle,
            description: data.project.description,
            image: data.project.image,
            imageAlt: data.project.imageAlt || "",
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow">
          {formData.codename ? (
            <div className="rounded-md border border-[#A8C117]/40 bg-[#f8fbe8] px-4 py-3">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#5a8f00]">
                Star codename (auto-assigned)
              </p>
              <p className="mt-1 text-lg font-semibold text-gray-900">
                Project {formData.codename}
              </p>
              {formData.displayTitle ? (
                <p className="mt-1 text-sm text-gray-600">
                  Public title: {formData.displayTitle}
                </p>
              ) : null}
            </div>
          ) : null}
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Banda Solar Project – 70 MW"
            />
          </div>
