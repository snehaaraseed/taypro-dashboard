...
const GLYDE_X_VS_NYUMA_X_ROW_KEYS = NYUMA_X_VS_NYUMA_ROW_KEYS;
...
export default async function NyumaXTrackerCleaningRobotPage({
  params,
}: {
  ...
  const manualVsRows = MANUAL_VS_ROW_KEYS.map((key) => ({
    ...
    nyumaX: t(`manualVsRobotic.${key}.nyumaX`),
  }));
