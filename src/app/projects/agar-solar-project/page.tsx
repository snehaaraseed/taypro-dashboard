...
export default function AgarSolarProject() {
  ...
  return (
    <>
      <SEO
        title="Agar Solar Project"
        description="The Agar 250 MW Solar Project is a breakthrough in generating more power..."
        keywords="agar solar, taypro solar projects, solar panel, advanced robotics, performance drive"
        url="http://localhost:3000/projects/agar-solar-project"
        breadcrumbs={breadcrumbs}
      />
      ...
      <div className="min-h-screen overflow-x-hidden px-4 sm:px-6 lg:px-0">
        ...
        <ProjectDescriptionSection
          ...
          image="/banda-solar.jpg"
          paragraphs={[
            `The Agar 250 MW Solar Project is a breakthrough in generating more power...`,
            `With Advance dual pass technology and the highest uptime guarantee...`,
          ]}
        />

        <ProjectQuoteSection
          quote="For the Agar Solar Project, we integrated advanced robotics..."
          author="Yogesh Kudale, CEO, TAYPRO PRIVATE LIMITED"
        />
