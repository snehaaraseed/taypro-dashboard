...
const breadcrumbs = [
  ...
  { name: "Soyegaon Maharashtra – 100 MW", href: "" },
];

const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://taypro.in";

export const metadata: Metadata = {
  title: "Soyegaon Maharashtra – 100 MW - Solar Panel Cleaning Robot Installation | Taypro",
  description: "A major 100 MW solar power project in Maharashtra with Solar Panel Cleaning Robot installation. One of our largest installations demonstrating Taypro's expertise in large-scale solar projects with robotic cleaning systems.",
  keywords: [
    "Soyegaon Solar Project",
    "100 MW solar project",
    "Maharashtra solar project",
  ...
  openGraph: {
    title: "Soyegaon Maharashtra – 100 MW - Solar Panel Cleaning Robot Installation | Taypro",
    description: "Major 100 MW solar power project in Maharashtra with Solar Panel Cleaning Robot installation.",
    images: [`${siteUrl}/tayprosolarfirm/soyegaon-solar.jpg`],
    url: `${siteUrl}/projects/soyegaon-solar-project`,
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Soyegaon Maharashtra – 100 MW Solar Project with Cleaning Robots",
    description: "Major 100 MW solar project in Maharashtra with Solar Panel Cleaning Robot installation.",
    images: [`${siteUrl}/tayprosolarfirm/soyegaon-solar.jpg`],
  },
  alternates: {
    canonical: `${siteUrl}/projects/soyegaon-solar-project`,
  },
};
