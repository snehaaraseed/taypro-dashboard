      ...
      <section className="w-full pt-20 pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-start">
          ...
          <p className="text-[#6B7280] text-lg mb-8">
            Explore our automatic Solar Panel Cleaning Robot installation projects. AI-enabled autonomous cleaning systems delivering highest efficiency and ROI.
          </p>
            ...
            {additionalProjects.map((card, idx) => (
              ...
              >
                <div className="relative w-full h-64 sm:h-72 md:h-80 overflow-hidden">
                  <Image
                    src={card.img}
                    alt={`${card.title} - Automatic Solar Panel Cleaning Robot Installation Project by Taypro`}
                    title={`${card.title} - Automatic Solar Panel Cleaning Robot Project`}
                    fill
                    sizes="sm"
