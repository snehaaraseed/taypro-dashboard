...
export default function ProjectTypePage() {
  ...
  return (
    <>
      ...
      <ItemListSchema
        scriptId="item-list-schema-projects-semi-automatic"
        name="Semi-automatic Solar Panel Cleaning Robot installation projects"
        description="Solar plants where Taypro Model-B pick-and-place semi-automatic robotic cleaning is deployed."
