/** Canonical path for dust-removal and generation-recovery disclosures. */
export const PERFORMANCE_METHODOLOGY_PATH =
...
export const ROOT_DEFAULT_OG_DESCRIPTION =
  "Autonomous waterless solar panel cleaning robots for utility-scale plants in India—dual-pass dry cleaning, Taypro Console fleet monitoring, and pan-India service.";
...
/** Short qualified claim for body copy and tables. */
export const DUST_REMOVAL_CLAIM_QUALIFIED =
  "99%+ dust removal per automated pass or cycle (platform- and site-dependent)";
